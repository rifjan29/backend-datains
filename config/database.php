    ...
    */
    ...
    'connections' => [
        ...
        'ditops' => [
            ...
            'host' => env('DB_HOST_DITOPS', '127.0.0.1'),
            'port' => env('DB_PORT_DITOPS', '3306'),
            'database' => env('DB_DATABASE_DITOPS', 'forge'),
            'username' => env('DB_USERNAME_DITOPS', 'forge'),
            'password' => env('DB_PASSWORD_DITOPS', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',

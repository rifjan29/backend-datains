...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'staging_tiga' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_STAGING_TIGA'),
            'host' => env('DB_HOST_KOMINFO_STAGING_TIGA', '127.0.0.1'),
            'port' => env('DB_PORT_KOMINFO_STAGING_TIGA', '3306'),
            'database' => env('DB_DATABASE_KOMINFO_STAGING_TIGA', 'forge'),
            'username' => env('DB_USERNAME_KOMINFO_STAGING_TIGA', 'forge'),
            'password' => env('DB_PASSWORD_KOMINFO_STAGING_TIGA', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',

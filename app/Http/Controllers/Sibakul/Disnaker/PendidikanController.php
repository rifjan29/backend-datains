...
use App\Models\Sibakul\Disnaker\Pendidikan;
...
class PendidikanController extends Controller
{
    public function index()
    {
        ...
        ->post('https://sibakuljogja.jogjaprov.go.id/restapi/api', [
            'data' => 'disnaker_trans_idmc_Laporan_Penduduk_Usia_Kerja_Berdasar_Pendidikan',
            'limit' => '0,100'
        ]);
    
        $data = $response->json();

        $key='disnaker_trans_idmc_Laporan_Penduduk_Usia_Kerja_Berdasar_Pendidikan';

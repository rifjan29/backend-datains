...
class SlemanController extends Controller
{
    public function index()
    {


        $url1 = "http://mam.jogjaprov.go.id/api/v1/cctvapplications/cd5cac04-2927-41ca-848d-5067694815c6/cctvs";
